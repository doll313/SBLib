...
#import "SBQRCodeTool.h"       //二维码生成工具

@implementation SBQRCodeTool
...
+ (UIImage *)sb_generateWithDefaultQRCodeData:(NSString *)data imageViewWidth:(CGFloat)imageViewWidth {
    ...
    return [SBQRCodeTool createNonInterpolatedUIImageFormCIImage:outputImage withSize:imageViewWidth];
}
